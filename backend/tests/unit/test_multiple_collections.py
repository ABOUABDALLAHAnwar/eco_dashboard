import pytest
from backend.database import handle_multiple_collections, collections_handeler
from backend.models import users_models


def test_handle_multiple_collections(client_accounts_collection, client_actions_collection, user_profile_infos_collection):
    """
    ...
    """
    data = {
        "name": "reduce_car_use_bicycle", "info": {
            "distance": 10,
            "type": "moyenne"}}
    ...
    multiple_collections = handle_multiple_collections.MultipleCollection(client_accounts_collection,  user_profile_infos_collection,client_actions_collection,)
